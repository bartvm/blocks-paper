...
network components like LSTM, GRU, support for attention 
mechanisms (for reference to different kinds of network architectures, 
regularization methods, optimization algorithms see ~\cite{Bengio-et-al-2015-Book}).
